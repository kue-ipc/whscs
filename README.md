...
7. `ansible-playbook restart_web.yml`
8. `ansible-playbook restart_app.yml`
9. `ansible-playbook health_check.yml`
...
3. `ansible-playbook restart_web.yml`
4. `ansible-playbook restart_app.yml`
5. `ansible-playbook conf_all.yml`
